...
const QUICK_ACCESS_ITEMS = [
  { id: 'users',    icon: 'users',   title: 'User Management',   subtitle: 'Add, edit and manage users & roles',  path: '/admin/users'              },
  { id: 'license',  icon: 'key',     title: 'License Management', subtitle: 'Seats, plan, and billing overview',   path: '/admin/license-management' },
  { id: 'overview', icon: 'columns', title: 'Admin Overview',    subtitle: 'Activity logs and org-level metrics',  path: '/admin/overview'           },
  { id: 'contact',  icon: 'phone',   title: 'Contact Centre',    subtitle: 'Route calls, queues, and IVR flows',   path: '/contact-centre'           },
]
...
const PRODUCTS = [
  { id: 'contact_center', icon: 'users', title: 'Contact Center',       tag: 'Primary Product' as ProductTag, description: 'Manage agents, queues, IVR, and call routing'            },
  { id: 'engage',         icon: 'users', title: 'Engage',               tag: 'Freemium'        as ProductTag, description: 'Build omnichannel campaigns to reach customers'           },
  { id: 'chatbot',        icon: 'users', title: 'Chatbot',              tag: 'Paid'            as ProductTag, description: 'AI-powered chatbot for customer self-service'             },
  { id: 'voicebot',       icon: 'users', title: 'Voicebot',             tag: 'Primary Product' as ProductTag, description: 'Automate customer conversations over voice'               },
  { id: 'cqa',            icon: 'users', title: 'Call Quality Analysis', tag: 'Paid'            as ProductTag, description: 'Monitor and score call quality at scale'                 },
  { id: 'ai_assist',      icon: 'users', title: 'AI Assist',            tag: 'Paid'            as ProductTag, description: 'Real-time AI guidance for your agents'                   },
]
